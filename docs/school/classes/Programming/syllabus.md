...
**Office Hours**: M 4:30pm-5:30pm (EIT 575), T 1:30pm-3:30pm (EIT 3rd Floor), W 9:30am10:30am 
...
Topics: • What is Programming • Programming Languages • Compilation vs Interpretation
• IDEs • Number Systems • Syntax vs Semantics • Debugging Mindset • Hello World •
Comments
...
Topics: • Coding Conventions (PEP 8) • Variables & Types • Arithmetic & Logical
Operations • Input/Output • f-strings • Type Casting • Errors & Tracebacks

Reading: Chapter 2 – Variables and Statements

**Week 3: Conditionals and Functions (Module 3)**

Topics: • if/elif/else • Boolean Logic • Truthy/Falsy • Function Definitions • Parameters &
Arguments • Scope
...
Topics: • Function Signatures • Default Arguments • Return Values • Modular Design •
...
Topics: • for/while Loops • range() • break/continue/pass • Accumulators • Index vs Direct
Iteration
...
Topics: • Lists • Indexing & Slicing • List Methods (Stacks/Queues) • Mutable vs Immutable
• Dictionaries • Tuples
...
Topics: • Strings as Sequences • Indexing & Slicing • String Methods • Regex • ASCII &
...
Topics: • Reading/Writing Files • File Modes • Line-by-Line vs Bulk Reads • Serialization •
Basic Databases • try/except • File Paths

Reading: Chapter 13 – Files and Databases

**Week 10: Classes (Module 9)**

Topics: • Class Definitions • Attributes & Methods • Object Interaction • Inheritance •
...
Topics: • Pseudorandom vs True Random • random Module • References & Aliasing •
deepcopy • Stack vs Heap • Intro Complexity • time Module

Reading: Custom Material

**Week 12: Python Tricks (Module 11)**

Topics: • Comprehensions • Conditional Expressions • Sets • Lambdas • map/filter/zip •
Unpacking • Iterators
...
Topics: • Linked Lists • Trees • Binary Search Trees • Time & Space Complexity • Algorithm
ReviewReading: Custom Material

**Week 14: C/C++ Primer (Module 13)**

Topics: • Python vs C/C++ Syntax • Manual Memory Management • Performance • Type
Declarations • Compilation Model
